...
const setStatusAsAuthor = (people) => people.forEach(index => index.isAuthor = true);
...
const append = (arr1, arr2) => arr2.forEach(index => arr1.push(index));
